...
abstract class BaseCourse extends AActiveRecord
{
    ...
    public function rules()
    {
        return array(
            ...
            array('program_id, rank_id, next_rank_id', 'length', 'max'=>10),
            array('name, rank_id, next_rank_id', 'default', 'setOnEmpty' => true, 'value' => null),
            array('id, name, program_id, rank_id, next_rank_id', 'safe', 'on' => 'search'),
        );
    }
    ...
    public function search()
    {
        ...
        $criteria->compare('next_rank_id', $this->next_rank_id);
